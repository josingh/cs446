...
class FosterParentsControllerTest < ActionController::TestCase
  ...
  test "should create foster_parent" do
    assert_difference('FosterParent.count') do
      post :create, foster_parent: { address: @foster_parent.address, email: @foster_parent.email, name: @foster_parent.name, pay_type: @foster_parent.pay_type }
    end
  ...
  test "should update foster_parent" do
    patch :update, id: @foster_parent, foster_parent: { address: @foster_parent.address, email: @foster_parent.email, name: @foster_parent.name, pay_type: @foster_parent.pay_type }
    assert_redirected_to foster_parent_path(assigns(:foster_parent))
  end
